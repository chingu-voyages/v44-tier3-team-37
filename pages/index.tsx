          ...
          <div className={s.collectionOuterContainer}>
            {organizationImages?.map(image => (
              <div className={s.imageContainer} key={image.id}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className={s.favoriteIcon} width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="#6eadf4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon></svg>
              </div>
            ))}
          </div>
        }
          ...
          <div className={s.collectionOuterContainer}>
            {allImages.map(image => (
              <div className={s.imageContainer} key={image.id}>
                ...
                {favorited(image.id)
                  ?
                  <svg xmlns="http://www.w3.org/2000/svg" onClick={() => updateUserCollection(image.id)} className={s.favoriteIcon} width="23" height="23" viewBox="0 0 24 24" fill="#6eadf4" stroke="#6eadf4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  :
